...
class Davinci_traj_streamer
{
public:
    //Davinci_traj_streamer(ros::NodeHandle* nodehandle); //"main" will need to instantiate a ROS nodehandle, then pass it to the constructor
    Davinci_traj_streamer();
